...
export default function Footer() {
  return (
    <footer className="bg-black/40 backdrop-blur-xl border-t border-white/5 pt-20 pb-10">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
        ...
        <div>
          ...
          <ul className="space-y-4 text-white/60 text-sm">
            <li><Link to="/" className="hover:text-white transition-colors">Packages</Link></li>
            <li><Link to="/#about" className="hover:text-white transition-colors">About Us</Link></li>
            <li><Link to="/#gallery" className="hover:text-white transition-colors">Hotels & Gallery</Link></li>
        ...
        <div>
          ...
          <ul className="space-y-4 text-white/60 text-sm">
            <li className="flex items-start gap-3">
              ...
              <span>123 Al Haram Street, Central District, Saudi Arabia</span>
            </li>
        ...
        <div className="flex flex-col items-center md:items-end justify-center">
          <div className="text-right mb-4">
            <span className="text-xs text-gold-premium font-medium uppercase tracking-widest block mb-1">Contact Official WhatsApp</span>
            <span className="text-lg font-bold tracking-[0.2em] text-white">+966 50 123 4567</span>
          </div>
          <div className="w-14 h-14 bg-green-600 rounded-full flex items-center justify-center shadow-lg shadow-green-900/40 cursor-pointer animate-bounce">
      ...
      <div className="max-w-7xl mx-auto px-6 mb-12 flex items-center justify-between gap-12 border-t border-white/5 pt-12">
        <span className="text-[10px] uppercase tracking-[0.3em] text-white/30 whitespace-nowrap">Global Partners</span>
        <div className="flex gap-12 items-center opacity-40 overflow-hidden">
          {["Hilton", "Mövenpick", "Saudia", "Marriott", "Hyatt"].map((partner) => (
            <span key={partner} className="font-serif italic text-lg text-white">{partner}</span>
          ))}
        </div>
      </div>
