  ...
  return (
    <div className="max-w-7xl mx-auto px-6">
      <div className="text-center mb-16">
        ...
        <h2 className="text-4xl md:text-5xl font-serif font-bold text-main mb-6">Voices of Peace</h2>
        <p className="text-sub max-w-2xl mx-auto font-light">Join the thousands of pilgrims who have trusted us with their spiritual journey.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {testimonials.map((review, i) => (
          <motion.div
            ...
            className="glass-dark p-8 rounded-[2.5rem] relative group hover:border-gold-premium/30 transition-all duration-500"
          >
            ...
            <p className={cn(
              "text-sub leading-relaxed mb-8 min-h-[100px]",
      ...
      <div className="mt-20 glass p-8 rounded-3xl flex flex-col md:flex-row items-center gap-12">
        <div className="flex-grow">
           <h3 className="text-2xl font-serif font-bold mb-4 text-main">Emotional Memories</h3>
           <p className="text-sub text-sm mb-6">Watch the real stories of our pilgrims as they experience the beauty of Al Haram.</p>
           <button className="flex items-center gap-2 text-gold-premium font-bold hover:gap-4 transition-all uppercase tracking-widest text-[10px]">
